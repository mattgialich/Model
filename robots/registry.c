...
/* Iteration 2-3: Enhanced biped with balance control */
...
const RobotModel ROBOT_MODELS[] = {
    ...
    {"biped",     "2-legged humanoid with arms (24 actuators)",
     biped_build,     biped_demo_controller},
    {"humanoid",  "same humanoid driven by the balance controller",
     biped_build,     biped_enhanced_controller},
};
